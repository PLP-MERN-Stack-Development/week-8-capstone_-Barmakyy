...
const AdminUsers = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-100 py-10 px-2 md:px-6 flex items-center justify-center">
      <div className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl p-8 md:p-12 relative">
        <button
        ...
        <h2 className="text-3xl font-bold text-teal-700 mb-8 text-center drop-shadow">User Management</h2>
        {loading ? (
