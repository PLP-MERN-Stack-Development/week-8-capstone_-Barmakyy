          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-gradient-to-br from-teal-100 to-blue-50 rounded-2xl shadow p-6 text-center">
                <div className="text-2xl font-extrabold text-teal-700">{facilities.length}</div>
                <div className="text-gray-600 mt-1">Facilities</div>
              </div>
              <div className="bg-gradient-to-br from-teal-100 to-blue-50 rounded-2xl shadow p-6 text-center">
                <div className="text-2xl font-extrabold text-teal-700">{openReports.length}</div>
                <div className="text-gray-600 mt-1">My Open Reports</div>
              </div>
              <div className="bg-gradient-to-br from-teal-100 to-blue-50 rounded-2xl shadow p-6 text-center">
                <div className="text-2xl font-extrabold text-teal-700">{resolvedReports.length}</div>
                <div className="text-gray-600 mt-1">My Resolved Reports</div>
              </div>
            </div>
            {/* Quick Actions */}
